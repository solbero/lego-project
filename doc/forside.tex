...
\graphicspath{{\subfix{./bilder/forside}}}
...
\begin{table}[hb]
    ...
    \begin{tabular}{|l|lll|}\hline
        ...
        \multicolumn{4}{|r|}{\scalebox{0.4}{\includegraphics{uis_logo}}}                                                                 \\[15mm]
        ...
        medlemmer    &                                                        &               &                                          \\[2mm]
                     & Per Olsen                                              & 6378983       & \scalebox{0.7}{\includegraphics{smiley}} \\[6mm]
                     & Pål Nilsen                                             & 6378984       & \scalebox{0.7}{\includegraphics{smiley}} \\[6mm]
                     & Eva Johnsen                                            & 6378985       & \scalebox{0.7}{\includegraphics{smiley}} \\[6mm]
                     & Anne Andersen                                          & 6378986       & \scalebox{0.7}{\includegraphics{smiley}} \\\hline
    \end{tabular}
\end{table}
